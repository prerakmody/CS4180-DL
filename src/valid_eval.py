...
## STEP-1
def _do_python_eval(_devkit_path, res_prefix, output_dir = 'output'):
...
if __name__ == '__main__':
    ...
    if (0):
        ...
        res_prefix   = os.path.join(DIR_PROJ, 'demo/demo3_yolov2/results/comp4_det_test_')
        _devkit_path = os.path.join(DIR_PROJ, 'data/dataset/VOCdevkit/')
        print (' - res_prefix : ', res_prefix)

        _do_python_eval(_devkit_path, res_prefix, output_dir = 'output')
